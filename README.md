...
incoming message
  ...
  -> Entity.decay_all()    per-emotion exponential decay (personality x category modifier)
...
Final decay rate: `base_rate(personality_score) x category_modifier`
...
|---------|-----------|----------|-------------------|
| Distress | 0.22 | x 0.30 | **0.066** - lingers |
| Anger | 0.22 | x 1.00 | **0.220** - fades normally |
| Surprise | 0.22 | x 1.50 | **0.330** - gone quickly |
